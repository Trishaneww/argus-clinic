       ...
       {/* <section className="flex flex-col afterHours">
        ...
        <section className="flex flex-col xl:flex-row gap-12 px-5 lg:px-20 mt-40 md:mt-64">
          <div className="flex flex-col text-center xl:text-left gap-6 xl:w-4/5">
            ...
            There is a FHO doctor, one of our colleagues, on call every evening from Monday to Friday from 5 pm to 8 pm and as of July 1, 2022, the FHO clinics started opening most Saturdays and Sundays.</p>
