...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col">
      <section className="flex flex-col hero">
        ...
        <div className="relative flex flex-col gap-2 mt-40 md:mt-72 items-center justify-center text-center">
          ...
          <div className="flex flex-col justify-center items-center w-full gap-2 p-2">
            ...
            <p className=" text-slate-900 text-md lg:text-2xl">Telephones answered Monday -Thursday 9:15 am - 12:00 pm and 1:15 pm - 4:00 pm, Friday 9:15 am - 12:00 pm</p>
          </div>
      ...
      <section className="flex flex-col md:w-4/5 lg:w-3/5 self-center text-center gap-4 my-14 mt-12 lg:mt-44 p-4">
        ...
        <p>Have available a list of your medications or all the bottles/packets. Your pharmacy can provide you with a list of your medications. Check if any medications are due for renewal in the next 1-3 months and discuss with your doctor.</p>
